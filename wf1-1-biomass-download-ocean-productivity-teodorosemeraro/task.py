...
conf_temp_path = conf_temp_path = '/tmp/data/WF1_1/' + 'tmp'
conf_input_path = conf_input_path = '/tmp/data/WF1_1/' + 'input'
                    ...
                    if filename.endswith('.hdf.gz'):
                        ...
                        if not response.ok:
                            ...
                            try:
                                ...
                                output_tif = convert_hdf_to_geotiff(outfile, os.path.join(dataset_path, model))
