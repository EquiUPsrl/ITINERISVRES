...
arg_parser.add_argument('--param_config_recurrence_plot_file', action='store', type=str, required=True, dest='param_config_recurrence_plot_file')
arg_parser.add_argument('--param_config_sarimax_file', action='store', type=str, required=True, dest='param_config_sarimax_file')
arg_parser.add_argument('--param_config_spline_file', action='store', type=str, required=True, dest='param_config_spline_file')
arg_parser.add_argument('--param_config_whittaker_file', action='store', type=str, required=True, dest='param_config_whittaker_file')
...
param_config_recurrence_plot_file = args.param_config_recurrence_plot_file.replace('"','')
param_config_sarimax_file = args.param_config_sarimax_file.replace('"','')
param_config_spline_file = args.param_config_spline_file.replace('"','')
param_config_whittaker_file = args.param_config_whittaker_file.replace('"','')
...
config_whittaker_file = download_file(param_config_whittaker_file, input_dir, 'config_whittaker.csv')
config_spline_file = download_file(param_config_spline_file, input_dir, 'config_spline.csv')
config_recurrence_plot_file = download_file(param_config_recurrence_plot_file, input_dir, 'config_recurrence_plot.csv')
config_sarimax_file = download_file(param_config_sarimax_file, input_dir, 'config_sarimax.csv')
...
file_config_recurrence_plot_file = open("/tmp/config_recurrence_plot_file_" + id + ".json", "w")
file_config_recurrence_plot_file.write(json.dumps(config_recurrence_plot_file))
file_config_recurrence_plot_file.close()
file_config_sarimax_file = open("/tmp/config_sarimax_file_" + id + ".json", "w")
file_config_sarimax_file.write(json.dumps(config_sarimax_file))
file_config_sarimax_file.close()
file_config_spline_file = open("/tmp/config_spline_file_" + id + ".json", "w")
file_config_spline_file.write(json.dumps(config_spline_file))
file_config_spline_file.close()
file_config_whittaker_file = open("/tmp/config_whittaker_file_" + id + ".json", "w")
file_config_whittaker_file.write(json.dumps(config_whittaker_file))
file_config_whittaker_file.close()
