...
arg_parser.add_argument('--formulas_file', action='store', type=str, required=True, dest='formulas_file')
...
formulas_file = args.formulas_file.replace('"','')
...
file_formulas_csv = open("/tmp/formulas_csv_" + id + ".json", "w")
file_formulas_csv.write(json.dumps(formulas_csv))
file_formulas_csv.close()
