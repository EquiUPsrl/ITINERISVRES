...
parameters_csv = parameters_file
...
file_parameters_csv = open("/tmp/parameters_csv_" + id + ".json", "w")
file_parameters_csv.write(json.dumps(parameters_csv))
file_parameters_csv.close()
