...
output_base_folder = statistics_path #os.path.join(work_path, "output", "Time Series Statistics")

target_columns = ["mean", "min", "max"]

output_subfolder = "corrected"            # output subfolder
...
def trova_prossimo_valido(values, start_index, prev_val):
    """Find the next valid value after start_index."""
